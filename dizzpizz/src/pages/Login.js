  ...
  return (
    <div className="flex w-full h-[500px] rounded-[50px]">
      <div className="bg-white text-black rounded-l-[10px] w-[64%] flex flex-col items-center h-full justify-center">
        <h1 className="text-[2em] font-bold m-[0.67em] text-[#000000d9]">Login to Your Account</h1>
        <form className="flex flex-col items-center w-full">
          ...
          <p>Forgot Password?</p>
          <button className="bg-[#fac564] m-[10px] rounded-[20px] text-[20px] font-bold py-[12px] w-[180px] text-center">Sign In</button>
        </form>
      </div>
      <div className="bg-[#fac564] w-[36%] rounded-r-[10px] flex flex-col items-center justify-center">
        <h1 className="text-[#fff] text-[2em] font-bold m-[0.67em]">New Here?</h1>
        <p className="bg-white rounded-[20px] text-[20px] font-bold py-[12px] w-[180px] text-center">Sign Up!</p>
      </div>
    </div>
  );
};
